...
const WorkspaceDetails = () => {
  ...
  function handleDueDateFilterChange( filter ) {
            ...
            <div className="board" key={ board.id } id={ board.id }>
              ...
              <div className="search-filter">
                ...
                <div className="due-date-filters">
                  <button onClick={ () => handleDueDateFilterChange( "" ) }>All</button>
                  <button onClick={ () => handleDueDateFilterChange( "DueToday" ) }>Due Today</button>
                  <button onClick={ () => handleDueDateFilterChange( "DueThisWeek" ) }>Due This Week</button>
                  <button onClick={ () => handleDueDateFilterChange( "Overdue" ) }>Overdue</button>
                </div>
              </div>
              <div className="card-content">
                { wtasks
                  ...
                  .map( ( task ) => (
                    <Card id="card" key={ task.id } sx={ { minWidth: 150, minHeight: 50 } }>
                      <Box sx={ { minWidth: 120 } }>
                        <h4>{ task.taskName }</h4>
                        <hr />
                        <div>
